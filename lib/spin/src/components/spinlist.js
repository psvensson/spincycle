...
(function() {
  define(['ractive', 'components/mdldialog'], (function(_this) {
    return function(Ractive, mdldialog) {
      var spinlist;
      spinlist = Ractive.extend({
        ...
        oninit: function() {
          ...
          return this.on('deleted', function(e) {
            var deleted;
