define(['ractive', 'components/spinlist', 'components/listelement'], (Ractive, spinlist, listelement) =>
  new Ractive(
    components: {spinlist: spinlist, listelement: listelement}
    el: 'body'
    data:
      testlist:[
        {name: 'foo', size:17, age: 1}
        {name: 'bar', size:4711, age: 441}
    ...
    template: '<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href=""><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">delete</i>Modules</a>
