...
(function() {
  ...
  OStore = (function() {
    ...
    OStore.sendUpdatesFor = function(obj, changed) {
      if (debug) {
        console.log('sendUpdatesFor called for obj ' + obj.id + ' changed = ' + changed + ', OStore.outstandingUpates[obj.id] = ' + OStore.outstandingUpates[obj.id] + ' anyone is loistening == ' + OStore.anyoneIsListening(obj.id));
      }
    ...
    OStore.anyoneIsListening = function(id) {
      return OStore.listeners[id] && OStore.listeners[id].length;
    };
