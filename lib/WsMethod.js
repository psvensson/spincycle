  ...
  WsMethod = (function() {
    ...
    WsMethod.prototype.expose = function(type) {
      ...
      this.messageRouter.addTarget('_delete' + type, 'obj', (function(_this) {
        return function(msg) {
          msg.type = type;
          return _this.messageRouter.objectManager._deleteObject(msg);
        };
      })(this));
      this.messageRouter.addTarget('_update' + type, 'obj', (function(_this) {
        return function(msg) {
          msg.type = type;
          return _this.messageRouter.objectManager._updateObject(msg);
        };
      })(this));
      this.messageRouter.addTarget('_get' + type, 'obj', (function(_this) {
        return function(msg) {
          msg.type = type;
          return _this.messageRouter.objectManager._getObject(msg);
        };
      })(this));
      return this.messageRouter.addTarget('_list' + type + 's', '<noargs>', (function(_this) {
        return function(msg) {
          msg.type = type;
          return _this.messageRouter.objectManager._listObjects(msg);
        };
      })(this));
    };
