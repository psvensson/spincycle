...
(function() {
  ...
  WsMethod = (function() {
    ...
    WsMethod.prototype.expose = function(type) {
      this.messageRouter.addTarget('_create' + type, 'obj', function(msg) {
        msg.type = type;
        return this.messageRouter.objectManager._createObject(msg);
      });
      this.messageRouter.addTarget('_delete' + type, 'obj', function(msg) {
        msg.type = type;
        return this.messageRouter.objectManager._deleteObject(type);
      });
      this.messageRouter.addTarget('_update' + type, 'obj', function(msg) {
        msg.type = type;
        return this.messageRouter.objectManager._updateObject(type);
      });
      this.messageRouter.addTarget('_get' + type, 'obj', function(msg) {
        msg.type = type;
        return this.messageRouter.objectManager._getObject(type);
      });
      return this.messageRouter.addTarget('_list' + type + 's', '<noargs>', function(msg) {
        msg.type = type;
        return this.messageRouter.objectManager._listObjects(type);
      });
    };
