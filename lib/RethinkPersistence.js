      ...
      return this.getDbFor(type).then((function(_this) {
        return function(db) {
          ...
          if (query != null ? query.limit : void 0) {
            ...
            rr = rr.skip(parseInt(query.skip || 0)).limit(parseInt(query.limit));
          }
        ...
        return function(db) {
          ...
          if (!rv.invalid) {
            rr = rr.filter(function(element) {
              return element(query.property).match(rv.value);
            });
            if (query.property2) {
      ...
      if (obj) {
        return this.getDbFor(type).then((function(_this) {
          return function(db) {
            var ex;
            if (debug) {
              console.log('Rethink.set using db ' + db);
            }
            try {
