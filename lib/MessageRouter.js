...
(function() {
  ...
  MessageRouter = (function() {
    ...
    function MessageRouter(authMgr, dburl, msgPS, app) {
      var pjson;
      ...
      this.addServicePage = __bind(this.addServicePage, this);
    ...
    MessageRouter.prototype.addServicePage = function() {
      ...
      if (this.app) {
        return this.app.use('/spin/', express["static"](path.join(__dirname, 'spin')));
      }
    };
