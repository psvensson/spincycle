...
(function() {
  var ClientEndpoints, DB, DDAPI, EventManager, HttpMethod, MessageRouter, OStore, ObjectManager, RateLimiter, RedisMethod, ResolveModule, SpinApp, SpinFunction, SpinModule, SpinTag, StatsD, SuperModel, Taginator, WsMethod, colors, defer, e, error, express, path, serveStatic,
  ...
  MessageRouter = (function() {
    ...
    function MessageRouter(authMgr, dburl, msgPS, app, dbtype, datadogOptions) {
      ...
      if (this.datadogOptions) {
        ...
        console.dir(this.datadogOptions);
        this.dogstatsd = new StatsD();
        DDAPI.init(this.datadogOptions);
      }
    ...
    MessageRouter.prototype.addServicePage = function() {
      ...
      return DB.createDatabases(['SpinModule', 'SpinFunction', 'SpinApp', 'SpinTag']).then((function(_this) {
        return function() {
          ...
          return _this.objectManager.expose('SpinApp');
        };
      })(this));
    };
