...
(function() {
  var ClientEndpoints, DB, DDAPI, EventManager, HttpMethod, MessageRouter, OStore, ObjectManager, RateLimiter, RedisMethod, ResolveModule, SpinFunction, SpinModule, StatsD, SuperModel, WsMethod, colors, defer, e, error, express, path, serveStatic,
