...
(function() {
  var ClientEndpoints, DB, EventManager, HttpMethod, MessageRouter, OStore, ObjectManager, RateLimiter, RedisMethod, ResolveModule, SpinFunction, SpinModule, SuperModel, WsMethod, defer, e, error, express, path, serveStatic,
