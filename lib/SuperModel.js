...
(function() {
  ...
  SuperModel = (function() {
            ...
            return (function(resolveobj) {
              ...
              if (resolveobj.value) {
                if (resolveobj.type) {
                  ...
                  _this.resolveObj(resolveobj, _this.record[resolveobj.value], r);
                } else {
                  ...
                  if (count === 0) {
                    ...
                    return ids.forEach(function(_id) {
                      return (function(id) {
                        ...
                        return _this.resolveObj(resolveobj, id, r);
                      })(_id);
                    });
                  }
                }
    ...
    SuperModel.prototype.resolveObj = function(resolveobj, id, r) {
