...
(function() {
  ...
  SuperModel = (function() {
    ...
    function SuperModel(record) {
      ...
      OMgr.getObject('all_' + this.constructor.type, this.constructor.type).then((function(_this) {
        return function(oo) {
          var _ref;
          if (oo) {
            if (debug) {
            ...
            if (_ref = _this.id, __indexOf.call(oo.list, _ref) < 0) {
              return oo.list.push(_this.toClient());
            }
          } else {
            if (debug) {
          ...
          return function(robj) {
            return (function(resolveobj) {
              ...
              if (resolveobj.value) {
                if (resolveobj.type) {
                  if (debug) {
                    console.log('supermodel creating direct reference of type ' + resolveobj.type + ', value ' + resolveobj.value + ' object ' + _this.record[resolveobj.value]);
                  }
                  if (debug) {
                    console.dir(_this.record[resolveobj.value]);
                  }
                  _this.resolveObj(resolveobj, _this.record[resolveobj.value], r, 0);
                } else {
