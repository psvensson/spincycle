          ...
          return function(robj) {
            return (function(resolveobj) {
              ...
              if (resolveobj.value) {
                if (resolveobj.type) {
                  if (debug) {
                    console.log('supermodel creating direct reference of type ' + resolveobj.type + ', value ' + resolveobj.value + ' name ' + resolveobj.name);
                  }
                  if (debug) {
                    console.dir(_this.record[resolveobj.value]);
                  }
                  return _this.resolveObj(resolveobj, _this.record[resolveobj.value].id, r, 0);
                } else {
