  ...
  DB = (function() {
    ...
    DB.getOrCreateObjectByRecord = function(record) {
      ...
      OStore.getObject(record.id, record.type).then(function(oo) {
        if (debug) {
          console.log('getOrCreateObjectByRecord OStore returns ' + oo);
        }
        if (oo) {
          return q.resolve(oo);
        } else {
          return DB.get(record.type, [record.id]).then(function(res) {
            if (debug) {
              console.log('getOrCreateObjectByRecord DB get returns ' + res);
            }
            if (debug) {
              console.dir(res);
            }
            ...
            return resolver.createObjectFrom(record).then(function(ooo) {
              if (debug) {
                console.log('getOrCreateObjectByRecord createFromRecord returns ' + ooo);
              }
