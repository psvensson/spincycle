...
(function() {
  ...
  DB = (function() {
    ...
    DB.createDatabases = function(dblist) {
      ...
      DB.getDataStore().then(function(store) {
        ...
        dblist.forEach(function(dbname) {
          ...
          DB.extendSchemaIfNeeded(DB.DataStore, dbname);
    ...
    DB.extendSchemaIfNeeded = function(db, dbname) {
      var proto, q;
      q = defer();
      ...
      db.all(dbname, {}, function(res) {
        var count, k, lookup, missing, o, v;
