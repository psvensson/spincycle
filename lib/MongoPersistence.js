...
(function() {
  ...
  MongoPersistence = (function() {
    ...
    madr = process.env['MONGODB_PORT_28017_TCP_ADDR'] || '127.0.0.1';

    mport = process.env['MONGODB_PORT_28017_TCP_PORT'] || '27017';
    ...
    MongoPersistence.prototype.foo = function(q) {
      return MongoClient.connect('mongodb://' + madr + ':' + mport + '/spincycle', (function(_this) {
        return function(err, db) {
          if (err) {
            console.log('MONGO Error connection: ' + err);
            console.dir(err);
            console.log('retrying.....');
            return setTimeout(_this.foo, 200);
          } else {
