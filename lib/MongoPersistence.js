        ...
        return function(collection) {
          return collection.findOne({
            ...
            if (err) {
              ...
              if (debug) {
                console.log('------ Mongo get found object');
              }
              if (debug) {
                console.dir(item);
              }
    ...
    MongoPersistence.prototype.extend = function(_type, id, field, def) {
      ...
      this.getDbFor(type).then((function(_this) {
        return function(collection) {
          var set;
          if (debug) {
            console.log('Mongo.extend called for type ' + type + ' new field  ' + field + ' and default value ' + def);
          }
          set = {
            $set: {}
          };
      ...
      return this.getDbFor(type).then((function(_this) {
        return function(collection) {
          ...
          return collection.update({
            ...
            if (debug) {
              console.log('mongo set result was ' + result);
            }
            if (err) {
