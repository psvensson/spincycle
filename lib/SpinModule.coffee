...
class SpinModule extends SuperModel
  ...
  @model =
    [
      ...
      # moduleConnetion elemnt look like this; {startNodule: 'xxx', endModule: 'yyy, starOutputName: 'zzz', endInputIndex: 'qqq'}
      ...
      # This is a list of modules that this modules has inside itself and which can have conenctions definted in 'moduleConnections'
