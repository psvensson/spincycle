        ...
        if (this.messageRouter.authMgr.canUserCreateThisObject(msg.obj.type, msg.user)) {
          ...
          return SuperModel.resolver.createObjectFrom(msg.obj).then((function(_this) {
            return function(o) {
              ...
              obj = {
                id: 'all_' + msg.obj.type,
                list: rv
              };
              return objStore.getObj('all_' + smg.obj.type, msg.obj.type).then(function(oo) {
                if (oo) {
                  return objStore.updateObj(obj);
                } else {
                  return objStore.storeObject(obj);
                }
              });
            };
          })(this));
