...
(function() {
  ...
  ObjectManager = (function() {
    function ObjectManager(messageRouter) {
      ...
      this.onDeregisterForPopulationChanges = __bind(this.onDeregisterForPopulationChanges, this);
        ...
        return function(newmodel) {
          ...
          for (k in sublist) {
            ...
            if (ClientEndpoints.exists(client)) {
              ...
              _results.push(ClientEndpoints.sendToEndpoint(client, {
