    ...
    ObjectManager.prototype._listObjects = function(msg) {
      ...
      if (typeof msg.type !== 'undefined') {
        if (this.messageRouter.authMgr.canUserListTheseObjects(msg.type, msg.user) === false) {
          ...
          if (msg.query) {
            if (debug) {
              console.log('executing query for property ' + msq.query.property + ', value ' + msq.query.value);
            }
            return DB.search(msg.type, msg.query.property, msg.query.value).then((function(_this) {
