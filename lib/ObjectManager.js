...
(function() {
  ...
  ObjectManager = (function() {
    ...
    ObjectManager.prototype.setup = function() {
      ...
      this.messageRouter.addTarget('getAccessTypesFor', 'type', this.onGetAccessTypesFor);
    ...
    ObjectManager.prototype.onGetAccessTypesFor = function(msg) {
      ...
      if (msg.type) {
        rv = {
          create: this.messageRouter.authMgr.canUserCreateThisObject(msg.type, msg.user),
          read: this.messageRouter.authMgr.canUserReadFromThisObject(msg.type, msg.user),
          write: this.messageRouter.authMgr.canUserWriteToThisObject(msg.type, msg.user),
          list: this.messageRouter.authMgr.canUserListTheseObjects(msg.type, msg.user)
        };
        return msg.replyFunc({
          status: e.general.SUCCESS,
          info: 'access types for ' + msg.type,
          payload: rv
        });
      } else {
        return msg.replyFunc({
    ...
    ObjectManager.prototype.onRegisterForUpdatesOn = function(msg) {
      ...
      if (msg.obj || !msg.obj.id || !msg.obj.type) {
        ...
        if (typeof msg.obj.id === 'string') {
          ...
          return msg.replyFunc({
            status: e.general.FAILURE,
            info: 'onRegisterForUpdatesOn wrong parameter format',
            payload: 'id'
          });
        }
      } else {
