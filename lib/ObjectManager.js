...
(function() {
  ...
  ObjectManager = (function() {
    ...
    ObjectManager.prototype.onUpdateObject = function(msg) {
      ...
      return objStore.getRecord(msg.obj.id, msg.obj.type).then((function(_this) {
        return function(record) {
          if (record) {
            if (_this.messageRouter.authMgr.canUserWriteToThisObject(record, msg.player)) {
    ...
    ObjectManager.prototype.onRegisterForUpdatesOn = function(msg) {
      ...
      return objStore.getRecord(msg.obj.id, msg.obj.type).then((function(_this) {
        return function(record) {
          var listenerId;
          if (record) {
            if (_this.messageRouter.authMgr.canUserReadFromThisObject(record, msg.player)) {
