...
(function() {
  ...
  ObjectManager = (function() {
    function ObjectManager(messageRouter) {
      ...
      this.changedPropertiesNotInBlacklist = __bind(this.changedPropertiesNotInBlacklist, this);
      ...
      this.blackList = ['id', 'createdAt', 'createdBy', 'updatedAt'];
    }
        ...
        return function(obj) {
          if (obj) {
            if (_this.messageRouter.authMgr.canUserWriteToThisObject(obj, msg.user)) {
              ...
              if (_this.changedPropertiesNotInBlacklist(obj, msg.obj)) {
                if (debug) {
                ...
                return msg.replyFunc({
                  status: e.general.NOT_ALLOWED,
                  info: 'Not allowed to change property',
                  payload: msg.obj.id
                });
              }
            } else {
    ...
    ObjectManager.prototype.changedPropertiesNotInBlacklist = function(origobj, chobj) {
      var p, rv;
      rv = true;
      for (p in origobj) {
        if (__indexOf.call(this.blackList, p) >= 0 && chobj[p] !== origobj[p]) {
