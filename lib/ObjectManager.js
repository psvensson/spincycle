...
(function() {
  ...
  ObjectManager = (function() {
    ...
    ObjectManager.prototype.onGetModelFor = function(msg) {
      if (msg.modelname) {
        return this.messageRouter.ResolveModule.resolve(msg.modelname, (function(_this) {
    ...
    ObjectManager.prototype._createObject = function(msg) {
      if (this.messageRouter.authMgr.canUserCreateThisObject(type, msg.user)) {
        console.dir(msg);
        if (msg.odata.type === type && this.messageRouter.authMgr.canUserCreateThisObject(msg.odata, msg.user)) {
          return SuperModel.resolver.createObjectFrom(msg.odata).then((function(_this) {
            return function(o) {
              return msg.replyFunc({
                status: e.general.SUCCESS,
                info: 'new ' + type,
    ...
    ObjectManager.prototype._getObject = function(msg) {
      return objStore.getObject(msg.obj.id, msg.obj.type.then((function(_this) {
        return function(obj) {
          if (obj) {
            if (_this.messageRouter.authMgr.canUserReadFromThisbject(obj, msg.user)) {
              return msg.replyFunc({
                status: e.general.SUCCESS,
                info: 'get object',
