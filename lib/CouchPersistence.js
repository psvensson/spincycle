...
(function() {
  var CouchPersistence, OStore, couchdb, debug, defer,
  ...
  CouchPersistence = (function() {
    ...
    CouchPersistence.prototype.query = function(_type, query, cb) {
      var rv, type;
      rv = [];
      type = _type.toLowerCase();
      return this.client.request(type, query, (function(_this) {
