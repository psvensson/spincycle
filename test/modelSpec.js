...
(function() {
  var AuthenticationManager, DB, OStore, SpinCycle, SuperModel, app, expect, express,
  ...
  describe('Spincycle Model Tests', function() {
    var Bar, Baz, Ezra, Foo, Fooznaz, Quux, authMgr, messageRouter, postCreateState, record, record2;
    authMgr = void 0;
    ...
    return it('should always return an array from listObjects', function() {
      var msg;
      msg = {
        type: 'Foo',
        user: {
