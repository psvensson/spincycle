...
(function() {
  var DB, OStore, SuperModel, expect,
  ...
  describe('Spincycle Model Tests', function() {
    var Bar, Baz, Ezra, Foo, Fooznaz, Quux, postCreateState, record, record2;
    ...
    return it('should only end one update even when storeObject is called multiple times on short notice', function(done) {
      var count;
      count = 0;
      return new Foo(record).then(function(foo) {
